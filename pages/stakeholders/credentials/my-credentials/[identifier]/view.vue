<template>
    <km-suspense>{{ record?.workingDocumentTitle }}
      ...
      <div class="print-section">
        <view-credential v-if="identifier" :identifier="identifier" @on-document-load="onDocumentLoad"></view-credential>
      </div>
    </km-suspense>
...
//@ts-nocheck
  ...
  // const schema     = useGetRealmSchema(SCHEMAS.REFERENCE_STAKEHOLDER_CREDENTIAL)
