<template>
    <div :class="{'dim-section':isBusy}">
        ...
        <form-wizard  @on-tab-change="onChangeCurrentTab" ref="formWizard">
            ...
            <CRow v-if="(activeTab == workflowTabs.submission.index || activeTab == workflowTabs.review.index)">
                <CCol>
...
<script setup>
    ...
    import FormWizard from '@/components/controls/edit/KmFormWizard.vue';
    import TabContent from '@/components/controls/edit/KmFormWizardTabContent.vue';
    ...
    const definedProps = defineProps({
        ...
        onSaveDraft                 : { type:Function, required:false },
    ...
    const workflowTabs = {
        submission  : { index : 0, title: t('submission') },
        review      : { index : 1, title: t('review') }
    }
