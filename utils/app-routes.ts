export const appRoutes = {
    ...
    NATIONAL_REPORTS_NSA                    : '/non-state-actors',
    NATIONAL_REPORTS_NSA_INTENTS            : '/non-state-actors/intents',
    NATIONAL_REPORTS_NSA_MY_INTENTS         : '/non-state-actors/intents/my-intents',
    NATIONAL_REPORTS_NSA_MY_INTENTS_NEW     : '/non-state-actors/intents/my-intents/new',
    NATIONAL_REPORTS_NSA_MY_INTENTS_EDIT    : '/non-state-actors/intents/my-intents/:identifier/edit',
    NATIONAL_REPORTS_NSA_MY_INTENT_VIEW     : '/non-state-actors/intents/my-intents/:identifier/view',
    NATIONAL_REPORTS_NSA_INTENT_VIEW        : '/non-state-actors/intents/:identifier/view',

    NATIONAL_REPORTS_NSA_COMMITMENTS        : '/non-state-actors/commitments',
    NATIONAL_REPORTS_NSA_MY_COMMITMENTS     : '/non-state-actors/commitments/my-commitments',
    NATIONAL_REPORTS_NSA_MY_COMMITMENTS_NEW : '/non-state-actors/commitments/my-commitments/new',
    NATIONAL_REPORTS_NSA_MY_COMMITMENTS_EDIT: '/non-state-actors/commitments/my-commitments/:identifier/edit',
    NATIONAL_REPORTS_NSA_MY_COMMITMENT_VIEW : '/non-state-actors/commitments/my-commitments/:identifier/view',
    NATIONAL_REPORTS_NSA_COMMITMENT_VIEW    : '/non-state-actors/commitments/:identifier/view',
